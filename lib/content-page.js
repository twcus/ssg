...
class ContentPage extends Page {
     ...
     */
    get attributes() {
        return Object.assign(super.attributes, { html: this.convertedContent });
    }
    ...
    /**
     * Get the layout to use for this content, as specified  in the frontmatter.
     * If no layout is specified, the converted HTML will be output as is.
     * @returns {string} The layout's content.
     */
    get layout() {
        return this.frontmatter.layout ? this.site.layouts[this.frontmatter.layout].content : this.convertedContent;
    }
